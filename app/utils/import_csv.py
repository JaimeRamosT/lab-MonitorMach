...
# import_csv.py está en: app/utils/
# Pokemon.csv está en: app/poke_stats/database/Pokemon.csv
SCRIPT_DIR = Path(__file__).parent  # app/utils/
APP_DIR = SCRIPT_DIR.parent  # app/
CSV_PATH = APP_DIR / 'poke_stats/database/Pokemon.csv'
